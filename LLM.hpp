...
class Gemma : public LLM {
  public:
    Gemma() : LLM("http://127.0.0.1:8080","WangYi","gemma") {}
};
class MedGemma : public LLM {
  public:
    MedGemma() : LLM("http://0.0.0.0:8080","WangYi","medgemma") {}
};
class Qwen : public LLM {
  public:
    Qwen() : LLM("http://0.0.0.0:8080","WangYi","qwen") {}
};
class Baichuan : public LLM {
  public:
    Baichuan() : LLM("http://0.0.0.0:8080","WangYi","baichuan") {}
};
class Muse : public LLM {
  public:
    Muse() : LLM("http://0.0.0.0:8080","WangYi","muse") {}
};
class LocalOffice : public LLM {
  public:
    LocalOffice() : LLM("http://10.157.72.109:8080","WangYi","Gemma-4_31B") {}
};

class DeepSeekFlash : public LLM {
  public:
    DeepSeekFlash() : LLM("https://api.deepseek.com", "sk-aeea16ba98c64a8d860e4ee1e99323d6", "deepseek-v4-flash") {}
};

class DeepSeekPro : public LLM {
  public:
    DeepSeekPro() : LLM("https://api.deepseek.com","sk-aeea16ba98c64a8d860e4ee1e99323d6", "deepseek-v4-pro") {}
};

class KIMIK3 : public LLM {
  public:
    KIMIK3() : LLM("https://api.qnaigc.com","sk-2472c0bba20406819b4d252f7e273d59b9e4e0707a27c915606445633e7b63fe", "moonshotai/kimi-k3") {}
};

class GLM53 : public LLM {
  public:
    GLM53() : LLM("https://api.qnaigc.com","sk-2472c0bba20406819b4d252f7e273d59b9e4e0707a27c915606445633e7b63fe", "z-ai/glm-5.3") {}
};

class Qwen38max : public LLM {
  public:
    Qwen38max() : LLM("https://api.qnaigc.com","sk-2472c0bba20406819b4d252f7e273d59b9e4e0707a27c915606445633e7b63fe", "qwen/qwen3.8-max") {}
};
